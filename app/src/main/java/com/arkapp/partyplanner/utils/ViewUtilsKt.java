...
public class ViewUtilsKt {
    ...
    public static void showAlertDialog(@NotNull Context context, @NotNull String title, @NotNull String message, @Nullable String positiveTxt, @NotNull String negativeTxt, @Nullable OnClickListener positiveListener) {
    ...
    public static void initVerticalAdapter(@NotNull RecyclerView recyclerView, @NotNull RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, boolean hasFixedSize) {
    ...
    public static void initGridAdapter(@NotNull RecyclerView recyclerView, @NotNull RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, boolean hasFixedSize, int gridSize) {
