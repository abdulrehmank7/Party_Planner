...
public final class SummaryDetails {
    ...
    public SummaryDetails(@Nullable Integer id, @Nullable Integer uid, @Nullable String partyDate, @Nullable String partyBudget, @Nullable String partyDestination, @Nullable Integer partyGuest, @Nullable String partyType, @Nullable String selectedDestination, @Nullable String selectedCaterers, @Nullable String extraNote, @Nullable String guestNameList, @Nullable String checkedItemList, @Nullable String locations) {
        this.id = id;
        this.uid = uid;
